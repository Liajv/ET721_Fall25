...
# change cicle1 color from 'red' to 'yellow'
...
print(f"The area of rectangle1 with width {rectangle1.width} and height {rectangle1.height} is {rectangle1.area()}")
print(f"The perimetr of rectangle2 = {rectangle2.perimeter()}")
...
print(f"Account holder name = {useraccount.account_holder}")
print(f"Initial balance = ${useraccount.balance:.2f}")
...
print(f"\nFinal balance = ${useraccount.balance:.2f}")
