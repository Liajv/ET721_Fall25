...
what is function?
- block of code that begins with 'def' follows by the the name of the function and parentheses():
...
"""
# import Python file
from lab5_Victor_function import *
...
min_num = 1
max_num = 10
rand_num = generate_random(min_num, max_num)
print(f"Generated number: {rand_num}")
