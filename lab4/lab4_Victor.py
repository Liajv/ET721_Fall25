...
print("----- Example 3: lenght of a dictionary -----")
...
print("----- Example 7: return items, key, and values in a dictionary -----")
...
print("----- EXERCISE -----")
# write a Python file to read the number of users that use 'gmail', 'hotmail', or 'yahoo' from the following list:
users = [
    "peterpan@yahoo.com",
    "annie@hotmail.com",
    "Carl@hotmail.com",
